---
name: generating-stitch-walkthrough-videos
description: "Generates walkthrough videos from Stitch projects using Remotion with smooth transitions, zooming, and text overlays. Use when the user wants to create a video showcase of Stitch screens, build a Remotion walkthrough, or generate a demo video from a Stitch project."
---
