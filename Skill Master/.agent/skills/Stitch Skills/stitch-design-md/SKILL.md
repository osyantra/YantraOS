---
name: generating-stitch-design-systems
description: "Analyzes Stitch projects and synthesizes semantic design systems into DESIGN.md files. Use when the user wants to create a design system document from a Stitch project, generate a DESIGN.md, or extract design tokens from Stitch screens."
---
