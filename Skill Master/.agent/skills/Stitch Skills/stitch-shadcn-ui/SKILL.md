...
description: "Provides expert guidance for integrating and building applications with shadcn/ui components. Use when the user wants to add shadcn/ui components, set up a shadcn project, customize shadcn themes, or build UI with shadcn/ui best practices."
---
