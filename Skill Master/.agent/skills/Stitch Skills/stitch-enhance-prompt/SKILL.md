---
name: enhancing-stitch-prompts
description: "Transforms vague UI ideas into polished, Stitch-optimized prompts. Use when the user wants to improve a Stitch prompt, polish a UI generation prompt, or enhance specificity with UI/UX keywords and design system context."
---
