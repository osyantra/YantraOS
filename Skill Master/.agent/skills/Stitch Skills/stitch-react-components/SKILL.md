---
name: converting-stitch-to-react
description: "Converts Stitch designs into modular Vite and React components with AST-based validation. Use when the user wants to convert a Stitch screen to React components, generate React code from Stitch designs, or build a component system from Stitch output."
---
