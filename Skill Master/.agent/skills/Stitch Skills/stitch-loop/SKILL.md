---
name: building-stitch-sites-iteratively
description: "Iteratively builds websites using Stitch with an autonomous baton-passing loop pattern. Use when the user wants to build a multi-page website with Stitch, set up an iterative build loop, or generate a complete site from Stitch screens."
---
